...
export default registerAs(
  ...
  (): MongodbStorageConfigType => ({
    ...
    getDbConnectionString: (): string =>
      getEnv('MONGO_CONNECTION_STRING', true),
    ...
    isDbAuthenticationEnabled: (): boolean =>
      getEnv('MONGO_AUTHENTICATION', true) === 'true',
    ...
    isDbKeepAliveEnabled: (): boolean =>
      getEnv('MONGO_KEEP_ALIVE', true) === 'true',
    ...
    isDbAutoReconnectEnabled: (): boolean =>
      getEnv('MONGO_AUTO_RECONNECT', true) === 'true',
    ...
    isDbCollectionAutoIndexEnabled: (): boolean =>
      getEnv('MONGO_COLLECTION_AUTOINDEX', true) === 'true',
    ...
    isDbCollectionAutoCreateEnabled: (): boolean =>
      getEnv('MONGO_COLLECTION_AUTOCREATE', true) === 'true',
    ...
    getDbConnectionRetries: (): number =>
      parseInt(getEnv('MONGO_CONNECT_RETRIES', true)),
    ...
    getDbConnectionRetriesDelay: (): number =>
      parseInt(getEnv('MONGO_CONNECT_RETRIES_DELAY', true)),
  }),
);
